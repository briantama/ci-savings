...
<div class='wrap-cap'>
<div class='cap' style='text-align: center; font-weight: bold;'>Report Data Withdrawal<br/ >Effective Date : <?php echo date('d M Y'); ?>
</div>
</div>
</div>
        ...
        <table border='1' class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
         <thead>
                  ...
                  <tbody>
                    ...
                    <?php
                    if($datawdh){
                     foreach($datawdh as $value){ 
                    ?>
                    
                    <tr>
                      <td><?php echo $value->WithdrawalID ?></td>
                      <td><?php echo $value->WithdrawalDate ?></td>
                      <td><?php echo $value->StudentID ?></td>
                      <td style="text-align: right;"><?php echo number_format($value->TotalWithdrawal) ?></td>

...
<div class='wrap-cap'>
<div class='cap' style='text-align: center; font-weight: bold;'>Report Data Deposit<br/ >Effective Date : <?php echo date('d M Y'); ?>
</div>
</div>
</div>
        ...
        <table border='1' class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
         <thead>
                  ...
                  <tbody>
                    ...
                    <?php
                    if($datadepo){
                     foreach($datadepo as $value){ 
                    ?>
                    
                    <tr>
                      <td><?php echo $value->DepositID ?></td>
                      <td><?php echo $value->DepositDate ?></td>
                      <td><?php echo $value->StudentID ?></td>
                      <td><?php echo $value->TotalDeposit ?></td>

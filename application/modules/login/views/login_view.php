<?php
  ...
  $res    = $this->db->query("
                              SELECT  SetupImage, SetupImageLogo, SetupName
                              FROM    M_Setupprofile
                            ");
            if ($res->num_rows() > 0) {
                $keyval = $res->row();
                $imgurl = $keyval->SetupImage;
                $imglgo = $keyval->SetupImageLogo;
              ...
              if($imglgo != ""){
                $uri = "./upload/logo/".$imglgo;
                  if(file_exists($uri)){
                    $urllogo = base_url()."/upload/logo/".$imglgo;
                  }
                  else{
                    $urllogo = base_url()."/upload/logo/default.jpeg";
                  }
              }
              else{
                $urllogo = base_url()."/upload/logo/default.jpeg";
...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo $urllogo; ?>">
              ...
              <div class="card-body">
                <!-- <form method="POST" action="#" class="needs-validation" novalidate=""> -->
                  <div class="form-group">
                    ...
                    <input id="text" type="username" class="form-control" name="username" id="username" v-model="formLogin.username" tabindex="1" required autofocus placeholder="UserName : brian">
                  ...
                  <div class="form-group">
                    ...
                    <input id="password" type="password" class="form-control" name="password" v-model="formLogin.password" tabindex="2" required placeholder="Password : brian">
                    <div class="invalid-feedback">
  ...
  var app     = new Vue({
    ...
    methods: {
      getLogin: function () {
        ...
        axios.post(base_url+'/ci-savings/login/getlogin', formData)

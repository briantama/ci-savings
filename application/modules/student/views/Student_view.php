...
<!-- form class-->
<div class="modal fade" tabindex="-1" role="dialog" id="getmodalStudent">
...
<div class="modal fade" tabindex="-1" role="dialog" id="getmodalcnfStudent">
...
<style>
 ...
 <script src="<?php echo base_url(); ?>stisla-master/assets/vuejs/master-student.js"></script>
 <script>
  // $('#dateof').datepicker({
  //  format: "yyyy-mm-dd",
  //  todayHighlight: true,

...
var app = new Vue({
  ...
  methods: {
  	getAllClass: function () {
  		axios.get(base_url+'/ci-savings/mclass/viewClass/view/10')
    ...
    selectRecord: function(){
      ...
      axios.get(base_url+'/ci-savings/mclass/viewClass/view/'+idxrecord)
      .then(function (response) {
        //console.log(response);
          app.users = response.data;
          console.log(response.data);
    ...
    addClass: function () {
      ...
      if(clsid == ""){
        ...
        axios.post(base_url+'/ci-savings/mclass/viewClass/save', formData)
        .then(function (response) {
          console.log(response);

...
var app = new Vue({
  ...
  methods: {
  	getSetupProfile: function () {
  		axios.get(base_url+'/ci-savings/setupprofile/viewSetupprofile/view')
    ...
    addStp: function () {
      ...
      if(stptl == ""){
        ...
        axios.post(base_url+'/ci-savings/setupprofile/viewSetupprofile/save', formData, {
        header:{
    ...
    selectEditStp(param) {
      ...
      //check file image exist
        ...
        http.open('HEAD', base_url+'/ci-savings/upload/profile/'+imageurl, false);
        http.send();
           
        console.log(http.status);

        if(http.status != 404){
          var urlimg = '<img alt="image" src="'+base_url+'/ci-savings/upload/profile/'+imageurl+'" width="120" height="120" class="rounded-circle profile-widget-picture">';
          app.uploadedImage        = urlimg;
            
        }
        else{
          app.uploadedImage = '<img alt="image" src="'+base_url+'/ci-savings/upload/profile/default.jpeg" width="220" height="220" class="rounded-circle profile-widget-picture">';
        }
    ...
    //   axios.post(base_url+'/ci-savings/mclass/viewClass/delete', formData)
    //   .then(function (response) {
    //     console.log(response);
    //     app.clickedClass = {};

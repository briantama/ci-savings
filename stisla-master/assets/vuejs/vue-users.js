...
var app = new Vue({
  ...
  methods: {
    ...
    customFormatter(date) {
  	...
  	getAllUser: function () {
  		axios.get(base_url+'/ci-savings/user/viewUser/view/10')
    ...
    selectRecord: function(){
      ...
      axios.get(base_url+'/ci-savings/user/viewUser/view/'+idxrecord)
      .then(function (response) {
        //console.log(response);
          app.users = response.data;
          console.log(response.data);
    ...
    addUsers: function () {
      ...
      // else if(pswdx == ""){
      //   app.validateformUser = "Please Insert Password";
      //   setTimeout(function () { app.validateformUser = "" }.bind(this), 5000);//set timeout notif
      //   this.$refs.password.focus();
      // }
      // else if(repswdx == ""){
      //   app.validateformUser = "Please Insert Re Password";
      //   setTimeout(function () { app.validateformUser = "" }.bind(this), 5000);//set timeout notif
      //   this.$refs.repassword.focus();
      // }
      else{
      
        axios.post(base_url+'/ci-savings/user/viewUser/save', formData)
        .then(function (response) {
          console.log(response);
    ...
    deleteUser: function () {
      ...
      axios.post(base_url+'/ci-savings/user/viewUser/delete', formData)
      .then(function (response) {
        console.log(response);
        app.clickedUser = {};

...
var app         = new Vue({
  ...
  data: {
    ...
    uploadedImageLogo:'<img alt="image" src="'+base_url+'/ci-savings/upload/logo/default.jpeg" width="240" height="240" class="rounded-circle profile-widget-picture">',
  },
  ...
  methods: {
  	...
  	getAllSetup: function () {
  		axios.get(base_url+'/ci-savings/logo/viewLogo/view')
          ...
          for (var key in obj) {
            ...
            http.open('HEAD', base_url+'/ci-savings/upload/logo/'+cekimg, false);
            http.send();
           
            console.log(idxtitle);

          if(http.status != 404){
            var urlimg = '<img alt="image" src="'+base_url+'/ci-savings/upload/logo/'+cekimg+'" width="240" height="240" class="rounded-circle profile-widget-picture">';
            ...
            app.uploadedImageLogo = '<img alt="image" src="'+base_url+'/ci-savings/upload/logo/default.jpeg" width="240" height="240" class="rounded-circle profile-widget-picture">';
            app.uploadedImageLogo       = urlimg;
            app.formLogo.setupid    = idxsetup;
            app.formLogo.setuptitle = idxtitle; 
            app.formLogo.setupname  = idxname;
    ...
    uploadImage:function(){
       ...
       axios.post(base_url+'/ci-savings/logo/viewLogo/save', formData, {
        header:{
        ...
        if(response.data.status == 'ok'){
         ...
         var urlimg             = '<img alt="image" src="'+base_url+'/ci-savings/upload/logo/'+response.data.filenm+'" width="240" height="240" class="rounded-circle profile-widget-picture">';
         app.uploadedImageLogo      = urlimg;
         //app.$refs.file.value   = '';

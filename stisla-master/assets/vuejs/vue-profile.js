...
var app         = new Vue({
  ...
  data: {
    ...
    imagefile: '',
    validateformProfile: '',
    uploadedImage:'<img alt="image" src="'+base_url+'/ci-savings/upload/user/default.jpeg" class="rounded-circle profile-widget-picture">',
  },
  ...
  methods: {
    ...
    customFormatter(date) {
  	...
  	getAllProfile: function () {
  		axios.get(base_url+'/ci-savings/profile/viewProfile/view')
          ...
          for (var key in obj) {
            ...
            http.open('HEAD', base_url+'/ci-savings/upload/user/'+cekimg, false);
            http.send();
           
            console.log(cekimg);

          if(http.status != 404){
            var urlimg = '<img alt="image" src="'+base_url+'/ci-savings/upload/user/'+cekimg+'" class="rounded-circle profile-widget-picture">';
            ...
            app.uploadedImage = '<img alt="image" src="'+base_url+'/ci-savings/upload/user/default.jpeg" class="rounded-circle profile-widget-picture">';
            app.uploadedImage        = urlimg;
            app.formProfile.idxadmin = idxadmin; 
            app.formProfile.namex    = idxadmnm;
            app.formProfile.emailx   = emailx;
    ...
    uploadImage:function(){
       ...
       axios.post(base_url+'/ci-savings/profile/viewProfile/save', formData, {
        header:{
        ...
        else
        {
         ...
         var urlimg             = '<img alt="image" src="'+base_url+'/ci-savings/upload/user/'+response.data.filenm+'" class="rounded-circle profile-widget-picture">';
         app.uploadedImage      = urlimg;
         app.$refs.file.value   = '';
    ...
    updateProfile: function () {
      ...
      if(pfnamex == ""){
        ...
        axios.post(base_url+'/ci-savings/profile/viewProfile/update', formData)
        .then(function (response) {
          console.log(response);
          app.formProfile = {};
